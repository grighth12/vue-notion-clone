...
export default {
  ...
  methods: {
    async workspacesInit() {
      ...
      console.log('workspace', this.$store.state.workspace.currentWorkspacePath);
    },
    navInit() {
...
nav { 
  ...
  .header {
    ...
    .user-profile {
      ...
      border-radius: 4px;
      margin-right: 10px;
      background-image: url("https://avatars.githubusercontent.com/u/68159627?v=4");
